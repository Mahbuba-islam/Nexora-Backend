...
var aiProvider = {
  ...
  getConfiguredProviders() {
    const list13 = [];
    if (envVars.OPENAI_API_KEY) list13.push("openai");
    if (envVars.GEMINI_API_KEY) list13.push("gemini");
    return list13;
  },
...
router30.use("/auth", authRoutes);
router30.use("/users", userRouter);
router30.use("/admin/products", adminProductRouter);
router30.use("/admin/users", adminUserRouter);
router30.use("/admin", adminRouter);
router30.use("/categories", categoryRouter);
router30.use("/brands", brandRouter);
router30.use("/products", productRouter);
router30.use("/search", searchRouter);
router30.use("/sellers", sellerRouter);
router30.use("/cart", cartRouter);
router30.use("/orders", orderRouter);
router30.use("/seller-orders", sellerOrderRouter);
router30.use("/payouts", payoutRouter);
router30.use("/addresses", addressRouter);
router30.use("/reviews", reviewRouter);
router30.use("/wishlist", wishlistRouter);
router30.use("/coupons", couponRouter);
router30.use("/refunds", refundRouter);
router30.use("/inventory", inventoryRouter);
router30.use("/shipping", shippingRouter);
router30.use("/", productQaRouter);
router30.use("/recommendations", recommendationRouter);
router30.use("/", stripeConnectRouter);
router30.use("/payments", PaymentRoutes);
router30.use("/notifications", notificationRouter);
router30.use("/ai", aiRoutes);
router30.use("/stats", StatsRoutes);
var indexRoutes = router30;
